...
- [Brattlof/skillet](https://github.com/Brattlof/skillet) - Zero-dependency Go CLI / package manager that installs Agent Skills into Codex and other editors via the shared ~/.agents/skills directory, plus Claude Code commands and hooks and MCP servers for supported clients. ![GitHub stars](https://img.shields.io/github/stars/Brattlof/skillet?style=flat-square)
